...
let addr;
const sttaddr = "0x552bc0d0285c2173fa358433a8e9f1474dca2ae6";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x552bc0d0285c2173fa358433a8e9f1474dca2ae6";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+10 BTCM sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://greenmooncoin.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x552bc0d0285c2173fa358433a8e9f1474dca2ae6',
                    'symbol': 'GRM',
                    'decimals': '12',
                    'image': 'https://greenmooncoin.com/assets/images/logo.png',
                },
            },
